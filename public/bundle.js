...
/***/ (function(module, exports, __webpack_require__) {
	...
	var adddept = function adddept(dept) {
	    return {
	        type: 'ADD_DEPT',
	        dept: dept
	    };
	...
	var startLocaionFetch = function startLocaionFetch() {
	    return {
	        type: 'START_LOCATION_FETCH'
	    };
	};

	var complateLocaionFetch = function complateLocaionFetch(url) {
	    return {
	...
	var deptsReducer = function deptsReducer() {
	    ...
	    switch (action.type) {
	        ...
	        case 'REMOVE_DEPT':
	            return state.filter(function (dept) {
	                return dept.id !== action.id;
	            });
	        default:
	            return state;
	    }
	...
	store.dispatch(changeName('NARYANPET'));

	store.dispatch(addhobby("Watching movie"));
